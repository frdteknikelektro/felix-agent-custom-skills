...
Use these only after the base skill has resolved `website_id`, token tier, permission, target, and confirmation requirements. Keep secrets and sensitive payloads out of logs and replies.
